...
/// @param {font} font - The font for the text
/// @param {real} x_offset - The outline offset in the x position
/// @param {real} y_offset - The outline offset in the y position
/// @param {string} str - The string to be printed
function print_data(x, y, color1, color2, font, x_offset, y_offset, str){
		
		draw_set_color(color2);
		draw_set_font(font);
		draw_text(x + x_offset, y, str);
		draw_text(x - x_offset, y, str);
		draw_text(x, y + y_offset, str);
		draw_text(x, y - y_offset, str);
